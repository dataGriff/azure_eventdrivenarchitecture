...
- [Prerequisites](#prerequisites)
  ...
  - [Create Azure Dashboard](#create-azure-dashboard)
...
5. Add your client IP address to a variable called MY_IP. You can get this value from [whatismyipaddress](https://whatismyipaddress.com/).
...
7. Your system environment variables should now look something like this.
![Environment Variables Azure](/Images/EnvironmentVariables.PNG)
![Environment Variables IP and Password](/Images/EnvironmentVariables1.PNG)
